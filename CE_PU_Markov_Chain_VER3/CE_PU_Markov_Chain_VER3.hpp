#ifndef _CE_PU_Markov_Chain_VER3_
#define _CE_PU_Markov_Chain_VER3_
...
class CE_PU_Markov_Chain_VER3 : public CognitiveEngine {
public:
  CE_PU_Markov_Chain_VER3(int argc, char**argv, ExtensibleCognitiveRadio *_ECR);
  ~CE_PU_Markov_Chain_VER3();
