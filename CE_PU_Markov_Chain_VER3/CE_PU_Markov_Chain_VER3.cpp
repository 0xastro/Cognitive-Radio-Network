...
#include "CE_PU_Markov_Chain_VER3.hpp"

// constructor
CE_PU_Markov_Chain_VER3::CE_PU_Markov_Chain_VER3(int argc, char **argv, ExtensibleCognitiveRadio *_ECR) {
  ECR = _ECR;
  first_execution = 1;
  period_s = 5;
}

CE_PU_Markov_Chain_VER3::~CE_PU_Markov_Chain_VER3() {}


// execute function
void CE_PU_Markov_Chain_VER3::execute() {
...
void CE_PU_Markov_Chain_VER3::PU_TX_Behaviour(ExtensibleCognitiveRadio *ECR) {
...
void CE_PU_Markov_Chain_VER3::PU_RX_Behaviour(ExtensibleCognitiveRadio *ECR) {
